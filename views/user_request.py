...
USERS = [
    {
        ...
        "first_name": "Mars",
        "last_name": "Bars",
        "email": "marsbars@gmail.com",
        "bio": "Just here", 
        "username": "marsbars123",
        "password": "asecret",
        "profile_image_url": "link.png",
...
def get_all_users():
    ...
    with sqlite3.connect("./db.sqlite3") as conn:
        ...
        for row in dataset:
            ...
            # Add dictionary representation of user to the list
...
def get_single_user(id):
    with sqlite3.connect("./db.sqlite3") as conn:
        ...
        # Create a user from the current row
        if data:
            user = User(
                    data['id'],
                    data['first_name'],
